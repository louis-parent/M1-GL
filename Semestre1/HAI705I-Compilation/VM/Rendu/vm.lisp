;=========================VM INTERNE====================================;
;Pour executer du code assembleur, veuillez aller en bas de cette page
...
(vm_create 'Roger 60000)

;=========================CHARGEUR DE LA VM====================================;

(vm_load 'Roger '(

;ecrire le code assembleur ici (possibiliter de faire un autre appel a vm_load pour separer du code assembleur)
