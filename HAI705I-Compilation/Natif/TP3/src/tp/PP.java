...
class PPLt extends PPBinOp
{
	...
	UPPExpr toUPP(ArrayList<String> locals)
	{
		return new UPPLt(this.e1.toUPP(locals), this.e2.toUPP(locals));
	}// toUPP
...
class PPNe extends PPBinOp
{
	...
	UPPExpr toUPP(ArrayList<String> locals)
	{
		return new UPPNe(this.e1.toUPP(locals), this.e2.toUPP(locals));
	}// toUPP
...
class PPGt extends PPBinOp
{
	...
	UPPExpr toUPP(ArrayList<String> locals)
	{
		return new UPPGt(this.e1.toUPP(locals), this.e2.toUPP(locals));
	}// toUPP
...
class PPArrayGet extends PPExpr
{
	...
	UPPExpr toUPP(ArrayList<String> locals)
	{
		UPPMul mul = new UPPMul(new UPPCte(4), this.index.toUPP(locals));
		UPPAdd add = new UPPAdd(this.arr.toUPP(locals), mul);
...
class PPArraySet extends PPInst
{
	...
	UPPInst toUPP(ArrayList<String> locals)
	{
		UPPMul mul = new UPPMul(new UPPCte(4), this.index.toUPP(locals));
		UPPAdd add = new UPPAdd(this.arr.toUPP(locals), mul);
		return new UPPStore(add, this.val.toUPP(locals));
	}// toUPP
...
class PPWhile extends PPInst
{
	...
	UPPInst toUPP(ArrayList<String> locals)
	{
		return new UPPWhile(this.cond.toUPP(locals), this.toUPP(locals));
	}// toUPP
...
class PPProcCall extends PPInst
{
	...
	{
		ArrayList<UPPExpr> args = new ArrayList<UPPExpr>();
		for(PPExpr expr : this.args)
		{
			args.add(expr.toUPP(locals));	
		}
		
		return new UPPProcCall(this.callee, args);
	}// toUPP
...
class PPProc extends PPDef
{
	...
	UPPDef toUPP()
	{
		...
		{
			locals.add(local.left);
		}
		
		
		return new UPPProc(this.name, args, locals, this.code.toUPP(locals));
	}// toUPP
